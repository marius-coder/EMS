...
class Ui_Form(QMainWindow):
    ...
    def setupUi(self, Form):
        ...
        self.label_PV = QtWidgets.QLabel(Form)
        ...
        self.doubleSpinBox_PV_kWp = QtWidgets.QDoubleSpinBox(Form)
        ...
        self.label_Bat = QtWidgets.QLabel(Form)
        ...
        self.doubleSpinBox_Bat_kWh = QtWidgets.QDoubleSpinBox(Form)
        ...
        #Entladetiefe
        self.spinBox_Entladetiefe = QtWidgets.QSpinBox(Form)
        ...
        self.label_Entladetiefe = QtWidgets.QLabel(Form)
        ...
        #Batterie Effizienz
        self.spinBox_Effizienz = QtWidgets.QSpinBox(Form)
        ...
        self.spinBox_Leistung = QtWidgets.QSpinBox(Form)
        ...
        self.radioButton_BatLeistungAbsolute = QtWidgets.QRadioButton(Form)
        ...
        self.radioButton_BatLeistungPercent = QtWidgets.QRadioButton(Form)
        ...
        #Selbstentladung
        self.spinBox_Selbstentladung = QtWidgets.QSpinBox(Form)
        ...
        self.label_Bat_2 = QtWidgets.QLabel(Form)
