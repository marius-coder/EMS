...
# Form implementation generated from reading ui file 'C:/Users/Marius/Desktop/form.ui'
#
...
class Ui_Erdwärme(QWidget):
    ...
    def __init__(self, parent):
        ...
        self.lineEdit_Adresse = QtWidgets.QLineEdit(self.widget)
        self.lineEdit_Adresse.setClearButtonEnabled(True)
        self.lineEdit_Adresse.setObjectName("lineEdit_Adresse")
        self.lineEdit_Adresse.setPlaceholderText("Höchstädtplatz 6, 1200 Wien")

        self.verticalLayout_10.addWidget(self.lineEdit_Adresse)
        ...
        self.label_cp.setText("cp Boden [kJ/kgK]")
        ...
        self.doubleSpinBox_WM = QtWidgets.QDoubleSpinBox(self.widget)
        self.doubleSpinBox_WM.setObjectName("doubleSpinBox_Bohrtiefe_2")
        self.verticalLayout_12.addWidget(self.doubleSpinBox_WM)
        ...
        self.spinBox_LangePixel = QtWidgets.QSpinBox(self.widget)
        self.spinBox_LangePixel.setObjectName("spinBox_LangePixel")
        self.label_LangePixel.setText("Länge Pixel [m]")

        self.verticalLayout_2.addWidget(self.spinBox_LangePixel)
        ...
        self.setGeometry(QtCore.QRect(570, 10, 224, 295))
        self.setObjectName("widget1")
        self.verticalLayout_21 = QtWidgets.QVBoxLayout(self)
        ...
        self.label_AnzPxl = QtWidgets.QLabel(self)
        ...
        self.lineEdit_AnzPxl = QtWidgets.QLineEdit(self)
        ...
        self.label_AnzCon = QtWidgets.QLabel(self)
        ...
        self.lineEdit_AnzCon = QtWidgets.QLineEdit(self)
        ...
        self.li_inputWidgets = [self.label_Adresse,self.spinBox_anzSonden,self.doubleSpinBox_absSonden,
                                self.doubleSpinBox_Bodentemperatur,self.spinBox_cp,self.spinBox_Dichte,
                                self.doubleSpinBox_Bohrtiefe,self.doubleSpinBox_WM,self.spinBox_Seitenlange,
                                self.spinBox_LangePixel]
    ...
    def SaveProfile(self):
        ...
        for widget in self.li_inputWidgets:
            if widget.objectName() == "label_Adresse":
